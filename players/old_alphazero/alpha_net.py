...
class PolicyV(torch.nn):
    ...
    def __init__(self):
        super().__init__()
        self.relu = nn.ReLU()
        self.dense1 = nn.Linear(SIZE, SIZE)
        self.dense2 = nn.Linear(SIZE, SIZE)
        self.v_out = nn.Linear(1, SIZE)
...
class PolicyP(torch.nn):
    ...
    def __init__(self):
        ...
        self.dense1 = nn.Linear(SIZE, SIZE)
        self.dense2 = nn.Linear(SIZE, SIZE)
        self.v_out = nn.Linear(SIZE, SIZE)
